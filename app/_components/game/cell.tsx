...
export default function Cell(props: CellProps) {
  ...
  return (
    <button
      className={`${bgColor} text-xs sm:text-sm md:text-base py-6 rounded-md break-all px-1 transition ease-in-out ${guessAnimation} ${wrongGuessAnimation}`}
      onClick={handleClick}
    >
      <h2 className={`${textColor} text-xs sm:text-xs md:text-base text-center font-bold`}>
